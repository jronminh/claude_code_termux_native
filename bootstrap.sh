...
# this repo to ~/claude-code-termux-native (or fast-forwards an existing
...
#   curl -fsSL .../bootstrap.sh | bash -s -- --with-notifications
set -euo pipefail

REPO_URL="https://github.com/jronminh/claude_code_termux_native.git"
REPO_DIR="$HOME/claude-code-termux-native"
